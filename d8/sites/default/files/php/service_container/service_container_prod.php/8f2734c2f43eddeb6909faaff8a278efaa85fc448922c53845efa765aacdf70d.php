...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    {
        return $this->services['container.namespaces'] = new \ArrayObject(array('Drupal\\system' => '/Users/bharatsharma/Dropbox/dev/demo.com/d8/core/modules/system/lib', 'Drupal\\user' => '/Users/bharatsharma/Dropbox/dev/demo.com/d8/core/modules/user/lib', 'Drupal\\Core\\Entity' => '/Users/bharatsharma/Dropbox/dev/demo.com/d8/core/lib', 'Drupal\\Core\\Field' => '/Users/bharatsharma/Dropbox/dev/demo.com/d8/core/lib', 'Drupal\\Core\\Http' => '/Users/bharatsharma/Dropbox/dev/demo.com/d8/core/lib', 'Drupal\\Core\\TypedData' => '/Users/bharatsharma/Dropbox/dev/demo.com/d8/core/lib', 'Drupal\\Core\\Validation' => '/Users/bharatsharma/Dropbox/dev/demo.com/d8/core/lib', 'Drupal\\Component\\Annotation' => '/Users/bharatsharma/Dropbox/dev/demo.com/d8/core/lib'));
    }
    ...
    {
        return $this->services['module_handler'] = new \Drupal\Core\Extension\CachedModuleHandler(array('system' => 'core/modules/system/system.module', 'user' => 'core/modules/user/user.module'), $this->get('state'), $this->get('cache.bootstrap'));
    }
    ...
    {
        return $this->services['plugin.manager.menu.local_action'] = new \Drupal\Core\Menu\LocalActionManager($this->get('controller_resolver'), $this->get('request'), $this->get('router.route_provider'), $this->get('module_handler'), $this->get('cache.cache'), $this->get('language_manager'), $this->get('access_manager'));
    }
    ...
    {
        return $this->services['plugin.manager.menu.local_task'] = new \Drupal\Core\Menu\LocalTaskManager($this->get('controller_resolver'), $this->get('request'), $this->get('router.route_provider'), $this->get('module_handler'), $this->get('cache.cache'), $this->get('language_manager'), $this->get('access_manager'));
    }
    ...
    {
        return $this->services['twig.loader.filesystem'] = new \Twig_Loader_Filesystem('/Users/bharatsharma/Dropbox/dev/demo.com/d8');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.namespaces' => array(
                'Drupal\\system' => '/Users/bharatsharma/Dropbox/dev/demo.com/d8/core/modules/system/lib',
                'Drupal\\user' => '/Users/bharatsharma/Dropbox/dev/demo.com/d8/core/modules/user/lib',
                'Drupal\\Core\\Entity' => '/Users/bharatsharma/Dropbox/dev/demo.com/d8/core/lib',
                'Drupal\\Core\\Field' => '/Users/bharatsharma/Dropbox/dev/demo.com/d8/core/lib',
                'Drupal\\Core\\Http' => '/Users/bharatsharma/Dropbox/dev/demo.com/d8/core/lib',
                'Drupal\\Core\\TypedData' => '/Users/bharatsharma/Dropbox/dev/demo.com/d8/core/lib',
                'Drupal\\Core\\Validation' => '/Users/bharatsharma/Dropbox/dev/demo.com/d8/core/lib',

...
function loginRadiusToggleShareTheme(theme) {
    ...
    if (theme == "vertical") {
        ...
        jQuery("#socialloginandsocialshare_horizontal").removeClass("active");
        jQuery("#socialloginandsocialshare_veritical").addClass("active");
        marginleft = '78px';
        ...
        marginleft = '20px';
        jQuery("#socialloginandsocialshare_horizontal").addClass("active");
        jQuery("#socialloginandsocialshare_veritical").removeClass("active");

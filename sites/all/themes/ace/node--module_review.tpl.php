...
if(arg(0) ==  "node"){
	...
	if($node->cid){
		...
		$review_comm_description.='<div id="review-comment">
					    ...
					    <div class="review-cooment-desc"> <span class="author-name"><b>'.ucfirst($user_profile->name).'</b>'.$cid->cid.'</span> <div class="featured-review-star-rating">'.$rating1.'</div>'.$comment_description.'</div>
					</div>';
	    }

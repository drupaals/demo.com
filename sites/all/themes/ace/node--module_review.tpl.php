...
if(arg(0) ==  "node"){
	...
	$drupal_download='<div class="drupal-download"><h4>Recommended releases</h4>'.htmlspecialchars_decode(substr($substr, 0,2512)).'</div>
	
			 </ br></ br><div class="drupal-dev-download" style="margin-top: 25px;"><h4>Development releases</h4>'.htmlspecialchars_decode(substr($substr1, 0,2512)).'
